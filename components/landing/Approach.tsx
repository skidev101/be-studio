...
export const Approach = () => {
  return (
    <section className="relative bg-white overflow-hidden px-10">
      <div className="flex gap-4 max-w-7xl px-6 py-32">
        <div>
            ...
            <div className="mt-16 flex flex-col gap-4">
              {steps.map((step, idx) => (
                <motion.div
                  ...
                  className="flex flex-col items-center md:items-start gap-4 p-6 rounded-xl transition-transform bg-white border border-gray-100 shadow-sm hover:shadow-md"
                >
                  {/* Icon */}
        ...
        {/* Image container */}
        <div className="relative w-full max-w-1/2 aspect-4/4 max-h-125 rounded-[4rem] border border-[#0B1C2D]/10 bg-[#F7F9FC] overflow-hidden shadow-sm">
          <Image
